...
export default async function FoundingMemberPage() {
  ...
  return <MemberShell active="profile" className="foundingPage">
    <div className="memberDashboardShell">
      <section className="foundingHero"><div><span>OPERATION LAUNCH</span><h1>Founding Member onboarding</h1><p>Tell us how you use Bullseye so the private beta can be supported responsibly. Submission creates a pending review only—it does not change billing, membership, or entitlement.</p></div><Link href="/dashboard">Return to dashboard</Link></section>
