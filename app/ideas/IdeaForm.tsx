...
export function IdeaForm() {
  ...
  async function submit(formData: FormData) {
    setState("saving");
    const response = await fetch("/api/ideas", { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify(Object.fromEntries(formData)) });
    ...
    setState("success"); router.push(`/ideas/${result.id}`); router.refresh();
  }
  return <form className="ideaForm" action={submit} aria-labelledby="submit-idea-title">
