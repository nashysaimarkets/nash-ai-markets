export const IDEA_CATEGORIES = ["Mission Control", "Market intelligence", "Options", "Risk management", "Trading journal", "Account and membership", "Mobile experience", "Other"] as const;
