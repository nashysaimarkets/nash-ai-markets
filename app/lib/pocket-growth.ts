...
export const GROWTH_EVENTS = ["introduction_viewed", "app_opened", "sample_viewed", "app_store_clicked", "chart_uploaded", "scan_started", "scan_completed", "scan_failed", "paywall_viewed", "purchase_started", "purchase_completed", "purchase_incomplete", "purchase_failed", "restore_completed"] as const;
...
export const GROWTH_CAMPAIGNS = ["discovery", "first10", "founding650", "directory", "other"] as const;
...
export function growthAttribution(params: URLSearchParams) {
