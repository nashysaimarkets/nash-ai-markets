...
export type LockedDecision = { id: string; createdAt: string; intention: Intention; image: string; analysis: Analysis; review?: ProcessReview; afterImage?: string; reviewedAt?: string; notebook?: { lesson: string; tags: string[]; updatedAt: string }; sourceImages?: import("./chart-session").ChartBundle };
