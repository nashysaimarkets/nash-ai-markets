...
export default function PocketFoundingPage() {
  return <main className="pfLaunch">
    ...
    <section id="founding" className="pfOffer"><div><span>FOUNDING 650 OFFER</span><h2>£4.99<small>/month</small></h2><p>Your Pocket Bullseye price stays at £4.99 per month for as long as that founding subscription remains continuously active.</p><ul><li>Exclusive access to the building of the main Bullseye project</li><li>Founder feedback and feature-influence channel</li><li>Intended £12/month main-project founding price when it launches, subject to final terms</li></ul></div><aside><strong>REGISTER YOUR INTEREST</strong><p>Secure checkout is being completed. Joining here takes no payment and creates no subscription.</p><WaitlistForm pocketFounding /><small>Places are assigned only after verified successful checkout. Cancelling ends the continuous-price guarantee.</small></aside></section>
