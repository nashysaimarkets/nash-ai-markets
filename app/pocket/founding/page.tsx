...
import CampaignVisit from "./CampaignVisit.tsx";
import FoundingWebOnly from "./FoundingWebOnly.tsx";
...
export default async function PocketFoundingPage({ searchParams }: {
  ...
  return <FoundingWebOnly><main className="pfLaunch">
    <CampaignVisit attribution={attribution} />
