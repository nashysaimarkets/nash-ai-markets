...
export default function Terms() {
  return <main className="legal"><header><Link href="/">← NASH AI MARKETS</Link></header><article>
    ...
    <h2>AI chart reviews</h2><p>A Second Opinion may misread a screenshot, omit context or produce an incorrect interpretation. It is designed to challenge a user-supplied plan, not validate a trade or provide an instruction. Do not rely on it as confirmation of market price, execution conditions, suitability or likely outcome.</p>
    ...
    <h2>Membership and billing</h2><p>Web memberships are billed through Stripe at the price and interval shown during checkout. Subscription management and cancellation are available through the customer portal or support. Cancellation stops future renewal and does not normally reverse a completed billing period unless required by law or an expressly stated refund policy.</p>
    <h2>Pocket Bullseye subscriptions on iOS</h2><p>The iOS app offers Pocket Bullseye Monthly as a one-month auto-renewable subscription. The price localised by Apple is shown before you confirm purchase. Payment is charged to your Apple Account. The subscription renews automatically for another month at the displayed price unless you cancel at least 24 hours before the end of the current period. You can manage or cancel the subscription in your Apple Account subscription settings and use Restore Purchases in the app to restore an active entitlement. Apple processes the purchase and any applicable refund request under its own terms. See our <a href="/privacy">Privacy Policy</a> for how selected chart images are handled.</p>
