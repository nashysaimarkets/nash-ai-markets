-- Align the authenticated RPC with the current onboarding UI contract.
-- Repeat the least-privilege table boundary so already-created staging
-- projects converge with fresh installations.
