  ...
  const gateway = status({
    providerAttempt: {
      ...
      endpointStatusCategories: {
        ...
        oil: "access_restricted",
        qqq: "access_restricted",
        nasdaq: "access_restricted",
      },
      quoteCount: 4,
...
test("reports only sanitized provider-variable presence", () => {
  ...
  const result = createLaunchDiagnostics({
    ...
    providerEnvironment: {
      ...
      fmpOilSymbolConfigured: false,
      fmpQqqSymbolConfigured: false,
      fmpNasdaqSymbolConfigured: false,
